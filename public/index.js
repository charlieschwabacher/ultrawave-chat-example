...
var Ultrawave = (function () {
  ...
  _createClass(Ultrawave, [{
    ...
    value: function joinOrCreate(group, initialData, cb) {
      ...
      return new Promise(function (resolve, reject) {
        var tries = 10;
        var attempt = function attempt(action) {
          return function () {
...
},{"./map_map":162,"./map_set":163,"./ws":165}],165:[function(require,module,exports){
'use strict';
...
},{"./map_set":163}],166:[function(require,module,exports){
module.exports = require('./lib/peergroup');
},{"./lib/peergroup":164}],167:[function(require,module,exports){
'use strict';
...
},{"./cursor_cache":167,"./deep_freeze":168,"./deep_merge":169}],171:[function(require,module,exports){
module.exports = require('./lib/ultrawave');
...
var ultrawave = new Ultrawave(location.hostname === 'localhost' ? 'ws://localhost:8000' : 'ws://examples-ultrawave.rhcloud.com:8000');
...
ultrawave.joinOrCreate('chat:' + location.search, [], function (data) {
